      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-xl border border-gray-200/50 dark:border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Sign in to continue to TaxPadi</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg pl-11 pr-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
          ...
          <button
            ...
            className="w-full py-3 bg-white/5 border border-white/10 hover:bg-white/10 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
          >
